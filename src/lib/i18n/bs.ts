...
export const bs: Dictionary = {
  ...
  hero: {
    ...
    bar: [
      ...
      { value: "8+ god", label: "Pravljenja proizvoda" },
    ],
    earnings: {
  ...
  work: {
    ...
    index: "01",
    headline: ["Pravljeno za", "prave kompanije."],
    body: "Osam godina platformi, aplikacija, web prodavnica i sistema koji ih drže u pogonu. Brendovi za kreatore su novo poglavlje — svaku kompaniju ispod možeš provjeriti.",
    selectLabel: "Izaberi projekat",
    visitLabel: "Otvori sajt",
    sectorLabel: "Sektor",
    placeLabel: "Sjedište",
    doesLabel: "Čime se bave",
    builtLabel: "Šta sam napravio",
    builtPending:
      "Opis projekta slijedi — kompanija je stvarna, tekst još nije napisan.",
    items: [
      {
      ...
      },
      {
        ...
        built: [
          "Web platforma i mobilna aplikacija",
          "Licenciranje za teška vozila i mašine",
        ],
      },
      {
  ...
  studio: {
    stats: [
      {
        value: "8+",
        label: "Godina pravljenja proizvoda",
        note: "Softver i online prodaja",
      },
      {
        value: "€0",
        label: "Za početak",
        note: "Ništa se ne plaća unaprijed",
      },
      {
        value: "Podjela",
        label: "Zarađujem kad ti zaradiš",
        note: "Nema rezultata, nema naknade",
      },
      {
        value: "4",
        label: "Dimenzije, jedan čovjek",
        note: "Brend · Proizvod · Rast · Tehnologija",
      },
    ],
    portraitAlt: "Anel Kujović, osnivač MintedScale-a",
    portraitSlot: "Mjesto za fotografiju",
    note: {
      lead: "Ja sam Anel. Preko osam godina radim na razvoju softvera i sistema za online prodaju — platforme, aplikacije, web prodavnice i naplata. Ona infrastruktura o kojoj niko ne priča, a bez koje biznis ne radi.",
      body: "MintedScale je isti pristup, samo usmjeren na kreatore. Većina onih koji Vam nude da izgrade brend su iz marketinga, ne znaju napraviti softver — strategija stigne, a proizvod nikad. Ja nudim i strategiju i proizvod.",
      offer:
        "Brendovi za kreatore su moj novi proizvod i radije ću to reći nego izmisliti listu klijenata. Zato partneri unaprijed ne plaćaju ništa: ja razvijam proizvod, ti lansiraš, a ja uzimam dio onoga što zaradi. Ako ne zaradi ništa, ne zarađujem ni ja.",
    ...
    followLabel: "Prati kako razvijam",
  },
  ...
  diagnosis: {
    ...
    body: "Milioni kreatora svaki dan grade publiku. Skoro ništa od te pažnje ne postane nešto njihovo. Pratioce samo iznajmljuješ — čim prestaneš objavljivati, prestaje i zarada. Brend je imovina. Ima vrijednost i zarađuje i kad spavaš, i može se prodati.",
    costLabel: "Cijena",
    faults: [
      {
        code: "01",
        title: "Ne postoji jasna strategija brenda",
        body: "Publika zna tebe, ali ne i za šta se zalažeš. Bez stava svaka saradnja izgleda isto i nijedna se ne naslanja na prethodnu.",
        state: "Nedefinisano",
      ...
      },
      {
        ...
        body: "Prihod je zamjena tvojih sati za sponzorske ugovore. Ništa ne radi bez tebe u kadru, tvoj kalendar je granica.",
        state: "Nije tvoje",
  ...
  method: {
    ...
    body: "Niz koraka, odrađen po redu. Svaki korak proizvede nešto što je tvoje prije nego počne sljedeći.",
    cta: "Počni graditi svoj brend",
    steps: [
      {
        n: "01",
        title: "Analiza",
        body: "Nauči da razumiješ svoju publiku, identitet i prilike.",
        detail:
          "Sistem analizira tvoju publiku: ko su, šta već kupuju, gdje je potražnja dovoljno jaka da se na nju može postaviti cijena. Rezultat je teza o pozicioniranju, a ne kolaž slika.",
      ...
      },
      {
        n: "02",
        title: "Građenje",
        body: "Kreiraj identitet, pozicioniranje i strategiju svog brenda.",
        detail:
          "Ime, uticaj, tonalitet i priča zbog kojih cijena ima smisla. Pravljeno tako da preživi i kad tvoje lice nije u kadru.",
      ...
      },
      {
        ...
        detail:
          "Proizvod, cijene, pakovanje, prodavnica i samo plasiranje — usklađeno uz tvoj kalendar objava, da se pažnja fokusira na nešto što se može kupiti.",
        output: "Linija proizvoda · Prodavnica · Plan plasmana",
        time: "Sedmica 7–12",
      },
      {
        n: "04",
        ...
        detail:
          "Zadržavanje kupaca, marža, procesi i sistemi koji kompaniji omogućavaju da raste brže od tvog rasporeda objavljivanja.",
  ...
  engine: {
    ...
    serif: "Nagađanje je ono što košta. Ono je uklonjeno.",
    videoLabel: "Unutar sistema",
    asideBody:
      "Svaka saradnja počinje analizom iz sistema. Rezultat vidiš prije nego se obavežeš.",
    asideCta: "Analiziraj moju publiku",
    videoNote:
      "Snimak stvarnog proizvoda. Prikazani kreator je primjer, nije partner.",
    ...
    shots: [
      ...
      "Views Tracker — rezultati analize jednog agenta",
    ],
    ...
    modules: [
      {
        ...
        tag: "Optimizacija brenda",
        body: "Čita tvoj profil, komentare i ono na šta tvoja publika već reaguje, pa ocjenjuje gdje je pozicioniranje slabo.",
        metric: "Izvještaj o pozicioniranju",
      },
      {
        code: "02",
        title: "Content Strategist",
        tag: "Sadržaj koji prodaje",
        body: "Povezuje šta objavljuješ sa onim što se prodaje, da ti kalendar objava i prodavnica prestanu raditi jedno protiv drugog.",
        metric: "Plan sadržaja",
      },
      {
        code: "03",
        title: "Audience Growth",
        tag: "Brži rast publike",
        body: "Pronalazi gdje se stvarno nalazi angažovani dio tvoje publike i šta privlači još takvih.",
        metric: "Plan rasta",
      },
      {
        code: "04",
        title: "Deal Finder",
        tag: "Pronalazak saradnji",
        body: "Izdvaja brendove čiji se kupci podudaraju sa tvojom publikom i koliko plaćaju kreatorima tvoje veličine.",
        metric: "Lista saradnji",
      },
      {
        code: "05",
        title: "Income Optimizer",
        tag: "Veći prihod",
        body: "Modelira tvoje nivoe cijena i redoslijed plasmana, pa projektuje kako izgleda cijela godina.",
        metric: "Model prihoda",
      },
    ],
  },
  ...
  calculator: {
    ...
    body: "Pomjeri klizače. Računica je prikazana u cijelosti — nema 'crne kutije' i nema 'praznih' obećanja.",
    ...
    projectedLabel: "Projekcija prvog plasmana",
    yearLabel: "Potencijal za 12 mjeseci",
    engagedRow: "Angažovana publika",
    conversionRow: "Konverzija plasmana",
    ...
    levers: [
      ...
      "Raspored plasmana uz tvoj kalendar objava",
    ],
    disclaimer:
      "Model, a ne obećanje. Primjenjuje stopu konverzije plasmana na tvoju angažovanu publiku — tvoja niša, ponuda i kvalitet liste pomjeraju je u oba smjera. Računicu prikazujem da je možeš provjeriti i osporiti.",
  },
  ...
  concepts: {
    ...
    disclaimer:
      "Koncepti. Kreatori su ilustrativnog karaktera, metodologija je stvarna. Brojke su projekcije iz modela u mom kalkulatoru, a ne rezultati — MintedScale tek očekuje prve partnere.",
    ...
    items: [
      {
        ...
        beforePoints: [
          ...
          "Bez prihoda između objava",
        ],
        line: "Oporavak i hidratacija",
        afterSummary:
          "Brend za oporavak s vlastitim stavom, direktna prodaja, uz pretplatu koja se naplaćuje bez obzira da li ona objavljuje ili ne.",
        deliverables: [
          "Identitet i pakovanje",
        ...
        horizon: "11 mjeseci do pune linije proizvoda",
      },
      {
        handle: "Kreator u finansijama",
        field: "Lične finansije",
        beforeSummary:
          "Objašnjava novac milionu ljudi. Zarađuje preko partnerskih linkova ka proizvodima koje nije napravio niti ih kontroliše.",
        beforePoints: [
          "Publika mu vjeruje, a kupuje negdje drugo",
          "Ne može diktirati cijenu",
          "Prihod zavisi od platforme",
        ],
        line: "Finansijska edukacija",
        afterSummary:
          "Škola s programom, kalendarom predavanja i softverom — naplaćena kao edukacija, a ne kao klik na partnerski link.",
        deliverables: [
          "Nastavni program i struktura kalendara",
          "Web aplikacija — praćenje i lekcije",
          "Program certifikacije",
          "Licenciranje kompanijama",
        ],
        ladderTiers: ["Ulazni", "Generacija", "Licenca"],
        model: "Školarina po generaciji polaznika · Pretplata na softver",
      ...
      },
      {
        ...
        beforePoints: [
          ...
          "Ima ukus, ali ništa nije vezano uz njega",
        ],
        line: "Predmeti i rasvjeta",
        afterSummary:
          "Dizajnerska kuća koja pravi proizvode pod njenim imenom, uz licencne ugovore koji plaćaju i bez ijedne objave.",
        deliverables: [
          "Vlastiti identitet i pravac dizajna",
  ...
  films: {
    ...
    body: "Kada partner lansira, njegov film ide ovdje — šta sam napravio, koliko zarađuje, njegovim riječima. Rezervisano, a ne izmišljeno.",
    cta: "Budi prvi",
  ...
  faq: {
    ...
    items: [
      {
        q: "Koliko košta?",
        a: "Unaprijed ništa. Radim uz podjelu prihoda: ja gradim brend, proizvod i tehnologiju o svom trošku i uzimam dio onoga što zaradi. Ako ne zaradi ništa, ne zarađujem ni ja. Procenat zavisi od toga koliko toga gradimo, pa ga postavljamo zajedno na pozivu — i ide u pisani ugovor, vremenski ograničeno, prije nego bilo šta počne. Ne potpisuješ nikakav udio u svojoj firmi.",
      },
      {
        q: "Nov si u brendovima za kreatore. Zašto bih riskirao?",
        a: "Zbog načina na koji je postavljena cijena, finansijski rizik ne nosiš ti nego ja. Rad na proizvodima nije nov: osam godina platformi, aplikacija i prodavnica za kompanije poput Accelit IT, Puzzles IT, TDT Training i Nationwide Appliance Repairs. Novo je to što to primjenjujem na brendove kreatora, i radije ću to reći otvoreno nego izmisliti listu kreatora. Počni besplatnom analizom i procijeni rad prije nego se obavežeš na nešto.",
      },
      {
        q: "Kolika mi publika treba?",
        a: "Nema konkretnih brojeva, ali angažman je daleko važniji od broja pratilaca. Publika od 30 hiljada koja komentariše i kupuje vrijedi više od 500 hiljada koji samo prođu pored. Ako brojke još ne opravdavaju saradnju, reći ću ti to otvoreno umjesto da uzmem posao.",
      },
      {
        q: "Koliko traje dok nešto ne bude vidljivo?",
        a: "Prvi plan u roku od 48 sati od poziva. Digitalni proizvod je proces od 8 do 12 sedmica; fizički proizvod traje duže, jer zavisi od proizvodnje/dobavljača. Cijeli raspored dobiješ prije nego počnemo, a ne poslije.",
      },
      {
        q: "Već imam proizvod. Možeš li i dalje pomoći?",
        a: "Često je to i bolja polazna tačka. Analiziram šta postoji, popravljam pozicioniranje i cijene, pa oko toga gradim sistem umjesto da krećemo od nule.",
      },
      {
        q: "Ko je vlasnik brenda?",
        a: "Ti — ime, identitet, prodavnica, lista kupaca, sve je na tvoje ime od prvog dana. Podjela prihoda je udio u prihodu, a ne u vlasništvu brenda.",
      },
    ],
  },
  ...
  application: {
    eyebrow: "Prijava",
    index: "09",
    headline: ["Spremni da svoje ime", "pretvorite u brend?"],
  ...
  console: {
    ...
    noSlots:
      "Trenutno nema slobodnih termina — pošalji poruku pa ću napraviti mjesta.",
    ...
    fields: {
      ...
      ideaMessage: "Poruka",
      ideaPlaceholder:
        "Šta radiš, ko te prati i kakav biznis želiš s druge strane toga.",
    },
    done: {
      ...
      sentToEmail: "Poslano na tvoju adresu e-pošte",
    ...
    errors: {
      ...
      slotTaken: "Taj termin je trenutno zauzet. Izaberi drugi.",
  ...
  finalCta: {
    ...
    body: "Donesi publiku i apetit — ja donosim strategiju, proizvod, tehnologiju i plasman. Unaprijed se ne plaća ništa.",
