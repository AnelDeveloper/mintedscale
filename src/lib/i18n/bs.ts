  ...
  engine: {
    ...
    modules: [
      ...
      },
      {
        ...
        body: "Izdvaja brendove čiji se kupci poklapaju s tvojom publikom i koliko plaćaju kreatorima tvoje veličine.",
      ...
      },
      {
        ...
        tag: "Veći prihod",
        body: "Modelira tvoje nivoe cijena i slijed lansiranja, pa projektuje kako izgleda cijela godina.",
